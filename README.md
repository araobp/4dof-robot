...
仕事では、ここ2年間、AIエージェント作り続けた末に出てきた結論：実は、目の前の仕事を楽にすることではなく、生成AIやMCPで企業や社会におけるサイロ化をなくすことこそ巨大なビジネスチャンス。ただ、なかなか、そういう大きなビジョンで物事考えられる人は少ない。このプロジェクトも、視野を広くするための活動。
